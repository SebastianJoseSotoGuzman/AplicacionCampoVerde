...
function validarnewcliente() {
    debugger
    var nombre = document.frm_nuevo.Txtacliente.value;
    var tipodoc = document.frm_nuevo.Txtidtipodocumento.value;
    var documento = document.frm_nuevo.txtdoc.value;
...
function validareditclientes() {
    debugger
    var nombre = document.frm_edit.Txtacliente.value;
    var tipodoc = document.frm_edit.Txtidtipodocumento.value;
    var documento = document.frm_edit.txtdoc.value;
